...
[![Pypi](https://img.shields.io/badge/pypi-v0.4.0-blue.svg)](https://pypi.org/project/docTR-Labeler/)
...
Python 3.11 (or higher) and [pip](https://pip.pypa.io/en/stable/) are required to install docTR-Labeler.
